...
static int qmp6988_get_calibration_data(void)
{
	...
	{
		status = qmp6988_ReadData(QMP6988_CALIBRATION_DATA_START+len,&a_data_u8r[len],1);
	}
#endif
...
#endif
	// press
	err = qmp6988_ReadData(QMP6988_PRESSURE_MSB_REG, a_data_u8r, 6);
	if(err == 0)
	{
